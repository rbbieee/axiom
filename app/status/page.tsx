...
const incidents = [
  {
    date: "2026-03-18",
    title: "Memory Index latency spike",
    body: "Elevated response times detected in memory retrieval layer. Root cause identified as index fragmentation. Partial mitigation applied. Full resolution in progress.",
    status: "ongoing",
  },
  {
    date: "2026-03-11",
    title: "Execution Layer brief interruption",
    body: "A 4-minute interruption affected task execution for a subset of active objectives. All affected tasks were automatically rescheduled. No data loss occurred.",
    status: "resolved",
  },
  {
    date: "2026-02-28",
    title: "Scheduled maintenance",
    body: "Planned downtime for context model retraining. All systems returned to full operation within the estimated window.",
    status: "resolved",
  },
];
    ...
    <div className="status-page">
      <div className="status-inner">
        ...
        <p className="status-meta">
          {threads} active threads &nbsp;&nbsp; {latency}ms avg latency
        </p>
            ...
            <div key={i} className="system-row">
              ...
              <div className="system-right">
                ...
                <span
                  ...
                  style={{
                    color: sys.status === "operational" ? "#4CAF50" : "#E8756A",
                  }}
                >
                  {sys.status}
                </span>
            ...
            <div key={i} className="incident">
              <div className="incident-header">
                ...
                <span
                  ...
                  style={{
                    color: inc.status === "ongoing" ? "#E8756A" : "#8A6E6C",
                  }}
                >
                  {inc.status}
                </span>
      ...
      <style>{`
        ...
        .system-row {
          ...
          align-items: center;
          border-bottom: 1px solid #1A0F0E;
          padding: 1.25rem 0;
        }
        .system-left {
          display: flex;
